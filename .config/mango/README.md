...
列出所有窗口	mmsg get all-clients
查看当前聚焦窗口	mmsg get focusing-client
列出所有显示器	mmsg get all-monitors
列出所有工作空间	mmsg get all-tags
查看指定窗口详情	mmsg get client <id>
查看版本	mmsg get version
